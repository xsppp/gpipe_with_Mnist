...
class Channel:
  ...
  """temp1 = sa.attach('shm://timing')
  temp2 = sa.attach('shm://info')
  temp3 = sa.attach('shm://stack_index')"""
  ...
  def Send(self, tensor):
    ...
    #print('sending tensor of size:',sys.getsizeof(tensor),time.time())
    """temp1 = sa.attach('shm://timing')
    temp2 = sa.attach('shm://info')
    temp3 = sa.attach('shm://stack_index')
    temp1[temp3[0]] = sys.getsizeof(tensor)
    temp2[temp3[0]] = "sending tensor size"
    temp3[0] +=1"""
  ...
  def Recv(self):
    ...
    if self._send_tpu_core == -1:
      ...
      #print('received tensor of size:',sys.getsizeof(received),time.time())
      """temp1[temp3[0]] = sys.getsizeof(received)
      temp2[temp3[0]] = "sending tensor size"
      temp3[0] +=1"""
      return received
    else:
